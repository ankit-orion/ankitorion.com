    ...
    <section className="relative w-full">
      ...
      <div className="py-20 md:py-32 px-4 md:px-8 max-w-4xl mx-auto font-handwriting">
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4 text-black dark:text-white">
        ...
        <div className="space-y-6 text-base sm:text-xl md:text-2xl lg:text-3xl text-gray-700 dark:text-gray-300 leading-relaxed font-medium mx-auto px-2 md:px-12 list-none text-center md:text-left">
